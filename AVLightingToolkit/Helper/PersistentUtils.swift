...
class PersistentUtils {
    ...
    func seedContext() {
        ...
        let contexts = [
            (imageFilename: "context1", name: "Car recognises pedestrian and gives way", position: 1, lightpattern: ["Notification as effects", "Notification as colours + effects"]),
            (imageFilename: "context2", name: "Car is speeding up", position: 2, lightpattern: ["Speed as colours", "Speed as colours vertically", "Speed as colours horizontally", "Speed as spatial information", "Speed as spatial information + effects"]),
